...
namespace SwipesCollectionManagement.UI.SwipesCollectingServiceReference {
    ...
    public interface ISwipesCollectingService {
        ...
        SwipesCollectionManagement.Service.Models.TerminalModel[] GetStatus();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISwipesCollectingService/GetStatus", ReplyAction="http://tempuri.org/ISwipesCollectingService/GetStatusResponse")]
        System.Threading.Tasks.Task<SwipesCollectionManagement.Service.Models.TerminalModel[]> GetStatusAsync();
        ...
        SwipesCollectionManagement.Service.Models.SwipeModel[] GetAllSwipes();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISwipesCollectingService/GetAllSwipes", ReplyAction="http://tempuri.org/ISwipesCollectingService/GetAllSwipesResponse")]
        System.Threading.Tasks.Task<SwipesCollectionManagement.Service.Models.SwipeModel[]> GetAllSwipesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISwipesCollectingService/DeleteAllSwipes", ReplyAction="http://tempuri.org/ISwipesCollectingService/DeleteAllSwipesResponse")]
        void DeleteAllSwipes();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISwipesCollectingService/DeleteAllSwipes", ReplyAction="http://tempuri.org/ISwipesCollectingService/DeleteAllSwipesResponse")]
        System.Threading.Tasks.Task DeleteAllSwipesAsync();
    }
    ...
    public partial class SwipesCollectingServiceClient : System.ServiceModel.ClientBase<SwipesCollectionManagement.UI.SwipesCollectingServiceReference.ISwipesCollectingService>, SwipesCollectionManagement.UI.SwipesCollectingServiceReference.ISwipesCollectingService {
        ...
        public SwipesCollectionManagement.Service.Models.TerminalModel[] GetStatus() {
            return base.Channel.GetStatus();
        }
        
        public System.Threading.Tasks.Task<SwipesCollectionManagement.Service.Models.TerminalModel[]> GetStatusAsync() {
            return base.Channel.GetStatusAsync();
        }
        
        public SwipesCollectionManagement.Service.Models.SwipeModel[] GetAllSwipes() {
            return base.Channel.GetAllSwipes();
        }
        
        public System.Threading.Tasks.Task<SwipesCollectionManagement.Service.Models.SwipeModel[]> GetAllSwipesAsync() {
            return base.Channel.GetAllSwipesAsync();
        }
        
        public void DeleteAllSwipes() {
            base.Channel.DeleteAllSwipes();
        }
        
        public System.Threading.Tasks.Task DeleteAllSwipesAsync() {
            return base.Channel.DeleteAllSwipesAsync();
        }
    }
}
